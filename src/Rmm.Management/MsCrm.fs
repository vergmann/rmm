...
module dbo =
    ...
    type WebResource =
        { OrganizationIdName: Option<string>
          ...
          SilverlightVersion: Option<string>
          WebResourceType: int
          OrganizationId: System.Guid
          SolutionId: System.Guid
          SupportingSolutionId: Option<System.Guid>
          [<SqlHydra.ProviderDbType("DateTime")>]
          OverwriteTime: System.DateTime
          ComponentState: int
          [<SqlHydra.ProviderDbType("DateTime")>]
          ModifiedOn: Option<System.DateTime>
          ModifiedBy: Option<System.Guid>
          ...
          CanBeDeleted: bool
          IsHidden: bool
          IntroducedVersion: Option<string>
          IsEnabledForMobileClient: bool
          DependencyXml: Option<string>
          IsAvailableForMobileOffline: bool }

    type WebResourceReader(reader: Microsoft.Data.SqlClient.SqlDataReader, getOrdinal) =
        member __.OrganizationIdName = OptionalColumn(reader, getOrdinal, reader.GetString, "OrganizationIdName")
        member __.ModifiedOnBehalfByYomiName = OptionalColumn(reader, getOrdinal, reader.GetString, "ModifiedOnBehalfByYomiName")
        member __.ModifiedOnBehalfByName = OptionalColumn(reader, getOrdinal, reader.GetString, "ModifiedOnBehalfByName")
        member __.CreatedOnBehalfByYomiName = OptionalColumn(reader, getOrdinal, reader.GetString, "CreatedOnBehalfByYomiName")
        member __.CreatedOnBehalfByName = OptionalColumn(reader, getOrdinal, reader.GetString, "CreatedOnBehalfByName")
        member __.WebResourceId = RequiredColumn(reader, getOrdinal, reader.GetGuid, "WebResourceId")
        member __.Name = RequiredColumn(reader, getOrdinal, reader.GetString, "Name")
        member __.DisplayName = OptionalColumn(reader, getOrdinal, reader.GetString, "DisplayName")
        member __.Description = OptionalColumn(reader, getOrdinal, reader.GetString, "Description")
        member __.Content = OptionalColumn(reader, getOrdinal, reader.GetString, "Content")
        member __.SilverlightVersion = OptionalColumn(reader, getOrdinal, reader.GetString, "SilverlightVersion")
        member __.WebResourceType = RequiredColumn(reader, getOrdinal, reader.GetInt32, "WebResourceType")
        member __.OrganizationId = RequiredColumn(reader, getOrdinal, reader.GetGuid, "OrganizationId")
        member __.SolutionId = RequiredColumn(reader, getOrdinal, reader.GetGuid, "SolutionId")
        member __.SupportingSolutionId = OptionalColumn(reader, getOrdinal, reader.GetGuid, "SupportingSolutionId")
        member __.OverwriteTime = RequiredColumn(reader, getOrdinal, reader.GetDateTime, "OverwriteTime")
        member __.ComponentState = RequiredColumn(reader, getOrdinal, reader.GetInt32, "ComponentState")
        member __.ModifiedOn = OptionalColumn(reader, getOrdinal, reader.GetDateTime, "ModifiedOn")
        member __.ModifiedBy = OptionalColumn(reader, getOrdinal, reader.GetGuid, "ModifiedBy")
        member __.CreatedOn = OptionalColumn(reader, getOrdinal, reader.GetDateTime, "CreatedOn")
        member __.CreatedBy = OptionalColumn(reader, getOrdinal, reader.GetGuid, "CreatedBy")
        member __.WebResourceIdUnique = RequiredColumn(reader, getOrdinal, reader.GetGuid, "WebResourceIdUnique")
        member __.ModifiedOnBehalfBy = OptionalColumn(reader, getOrdinal, reader.GetGuid, "ModifiedOnBehalfBy")
        member __.CreatedOnBehalfBy = OptionalColumn(reader, getOrdinal, reader.GetGuid, "CreatedOnBehalfBy")
        member __.LanguageCode = OptionalColumn(reader, getOrdinal, reader.GetInt32, "LanguageCode")
        member __.IsManaged = RequiredColumn(reader, getOrdinal, reader.GetBoolean, "IsManaged")
        member __.IsCustomizable = RequiredColumn(reader, getOrdinal, reader.GetBoolean, "IsCustomizable")
        member __.CanBeDeleted = RequiredColumn(reader, getOrdinal, reader.GetBoolean, "CanBeDeleted")
        member __.IsHidden = RequiredColumn(reader, getOrdinal, reader.GetBoolean, "IsHidden")
        member __.IntroducedVersion = OptionalColumn(reader, getOrdinal, reader.GetString, "IntroducedVersion")
        member __.IsEnabledForMobileClient = RequiredColumn(reader, getOrdinal, reader.GetBoolean, "IsEnabledForMobileClient")
        member __.DependencyXml = OptionalColumn(reader, getOrdinal, reader.GetString, "DependencyXml")
        member __.IsAvailableForMobileOffline = RequiredColumn(reader, getOrdinal, reader.GetBoolean, "IsAvailableForMobileOffline")
        ...
        member __.Read() =
            { OrganizationIdName = __.OrganizationIdName.Read()
              ...
              CreatedOnBehalfByYomiName = __.CreatedOnBehalfByYomiName.Read()
              CreatedOnBehalfByName = __.CreatedOnBehalfByName.Read()
              WebResourceId = __.WebResourceId.Read()
              Name = __.Name.Read()
              DisplayName = __.DisplayName.Read()
              Description = __.Description.Read()
              Content = __.Content.Read()
              SilverlightVersion = __.SilverlightVersion.Read()
              WebResourceType = __.WebResourceType.Read()
              OrganizationId = __.OrganizationId.Read()
              SolutionId = __.SolutionId.Read()
              SupportingSolutionId = __.SupportingSolutionId.Read()
              OverwriteTime = __.OverwriteTime.Read()
              ComponentState = __.ComponentState.Read()
              ModifiedOn = __.ModifiedOn.Read()
              ModifiedBy = __.ModifiedBy.Read()
              CreatedOn = __.CreatedOn.Read()
              CreatedBy = __.CreatedBy.Read()
              WebResourceIdUnique = __.WebResourceIdUnique.Read()
              ModifiedOnBehalfBy = __.ModifiedOnBehalfBy.Read()
              CreatedOnBehalfBy = __.CreatedOnBehalfBy.Read()
              LanguageCode = __.LanguageCode.Read()
              IsManaged = __.IsManaged.Read()
              IsCustomizable = __.IsCustomizable.Read()
              CanBeDeleted = __.CanBeDeleted.Read()
              IsHidden = __.IsHidden.Read()
              IntroducedVersion = __.IntroducedVersion.Read()
              IsEnabledForMobileClient = __.IsEnabledForMobileClient.Read()
              DependencyXml = __.DependencyXml.Read()
              IsAvailableForMobileOffline = __.IsAvailableForMobileOffline.Read() }

        member __.ReadIfNotNull() =
            if __.WebResourceId.IsNull() then None else Some(__.Read())

    [<CLIMutable>]
    type WebResourceAsIfPublished =
        { OrganizationIdName: Option<string>
          ModifiedOnBehalfByYomiName: Option<string>
          ModifiedOnBehalfByName: Option<string>
          CreatedOnBehalfByYomiName: Option<string>
    ...
    type WebResourceAsIfPublishedReader(reader: Microsoft.Data.SqlClient.SqlDataReader, getOrdinal) =
        member __.OrganizationIdName = OptionalColumn(reader, getOrdinal, reader.GetString, "OrganizationIdName")
        member __.ModifiedOnBehalfByYomiName = OptionalColumn(reader, getOrdinal, reader.GetString, "ModifiedOnBehalfByYomiName")
        member __.ModifiedOnBehalfByName = OptionalColumn(reader, getOrdinal, reader.GetString, "ModifiedOnBehalfByName")
        member __.CreatedOnBehalfByYomiName = OptionalColumn(reader, getOrdinal, reader.GetString, "CreatedOnBehalfByYomiName")
    ...
    type WebResourceBaseReader(reader: Microsoft.Data.SqlClient.SqlDataReader, getOrdinal) =
        member __.Name = RequiredColumn(reader, getOrdinal, reader.GetString, "Name")
        member __.IsManaged = RequiredColumn(reader, getOrdinal, reader.GetBoolean, "IsManaged")
        member __.WebResourceType = RequiredColumn(reader, getOrdinal, reader.GetInt32, "WebResourceType")
        member __.ComponentState = RequiredColumn(reader, getOrdinal, reader.GetInt32, "ComponentState")
        ...
        member __.ReadIfNotNull() =
            if __.ComponentState.IsNull() then None else Some(__.Read())

    [<CLIMutable>]
    type WebResourceBaseIds = { WebResourceId: System.Guid }

    type WebResourceBaseIdsReader(reader: Microsoft.Data.SqlClient.SqlDataReader, getOrdinal) =
        member __.WebResourceId = RequiredColumn(reader, getOrdinal, reader.GetGuid, "WebResourceId")
    ...
    type WebResourceLogicalReader(reader: Microsoft.Data.SqlClient.SqlDataReader, getOrdinal) =
        member __.OrganizationIdName = OptionalColumn(reader, getOrdinal, reader.GetString, "OrganizationIdName")
        member __.ModifiedOnBehalfByYomiName = OptionalColumn(reader, getOrdinal, reader.GetString, "ModifiedOnBehalfByYomiName")
        member __.ModifiedOnBehalfByName = OptionalColumn(reader, getOrdinal, reader.GetString, "ModifiedOnBehalfByName")
        member __.CreatedOnBehalfByYomiName = OptionalColumn(reader, getOrdinal, reader.GetString, "CreatedOnBehalfByYomiName")
    ...
    [<CLIMutable>]
    type WebResourceLogicalAsIfPublished =
        { OrganizationIdName: Option<string>
          ModifiedOnBehalfByYomiName: Option<string>
          ModifiedOnBehalfByName: Option<string>
          CreatedOnBehalfByYomiName: Option<string>
    ...
    type WebResourceLogicalAsIfPublishedReader(reader: Microsoft.Data.SqlClient.SqlDataReader, getOrdinal) =
        member __.OrganizationIdName = OptionalColumn(reader, getOrdinal, reader.GetString, "OrganizationIdName")
        member __.ModifiedOnBehalfByYomiName = OptionalColumn(reader, getOrdinal, reader.GetString, "ModifiedOnBehalfByYomiName")
        member __.ModifiedOnBehalfByName = OptionalColumn(reader, getOrdinal, reader.GetString, "ModifiedOnBehalfByName")
        member __.CreatedOnBehalfByYomiName = OptionalColumn(reader, getOrdinal, reader.GetString, "CreatedOnBehalfByYomiName")
    ...
    type WebResourceSnapshotReader(reader: Microsoft.Data.SqlClient.SqlDataReader, getOrdinal) =
        member __.WebResourceId = RequiredColumn(reader, getOrdinal, reader.GetGuid, "WebResourceId")
        member __.Name = RequiredColumn(reader, getOrdinal, reader.GetString, "Name")
        member __.DisplayName = OptionalColumn(reader, getOrdinal, reader.GetString, "DisplayName")
        member __.Description = OptionalColumn(reader, getOrdinal, reader.GetString, "Description")
...
type HydraReader(reader: Microsoft.Data.SqlClient.SqlDataReader) =
    ...
    let lazydboWebResource = lazy (dbo.WebResourceReader(reader, buildGetOrdinal 34))
    let lazydboWebResourceAsIfPublished = lazy (dbo.WebResourceAsIfPublishedReader(reader, buildGetOrdinal 34))
    let lazydboWebResourceBase = lazy (dbo.WebResourceBaseReader(reader, buildGetOrdinal 29))
    let lazydboWebResourceBaseIds = lazy (dbo.WebResourceBaseIdsReader(reader, buildGetOrdinal 1))
    let lazydboWebResourceLogical = lazy (dbo.WebResourceLogicalReader(reader, buildGetOrdinal 34))
    let lazydboWebResourceLogicalAsIfPublished = lazy (dbo.WebResourceLogicalAsIfPublishedReader(reader, buildGetOrdinal 34))
    let lazydboWebResourceSnapshot = lazy (dbo.WebResourceSnapshotReader(reader, buildGetOrdinal 27))
    ...
    member __.``dbo.WebResource`` = lazydboWebResource.Value
    member __.``dbo.WebResourceAsIfPublished`` = lazydboWebResourceAsIfPublished.Value
    member __.``dbo.WebResourceBase`` = lazydboWebResourceBase.Value
    member __.``dbo.WebResourceBaseIds`` = lazydboWebResourceBaseIds.Value
    member __.``dbo.WebResourceLogical`` = lazydboWebResourceLogical.Value
    member __.``dbo.WebResourceLogicalAsIfPublished`` = lazydboWebResourceLogicalAsIfPublished.Value
    member __.``dbo.WebResourceSnapshot`` = lazydboWebResourceSnapshot.Value
    ...
    member private __.GetReaderByName(entity: string, isOption: bool) =
        ...
        | "dbo.WebResource", false -> __.``dbo.WebResource``.Read >> box
        | "dbo.WebResource", true -> __.``dbo.WebResource``.ReadIfNotNull >> box
        | "dbo.WebResourceAsIfPublished", false -> __.``dbo.WebResourceAsIfPublished``.Read >> box
        | "dbo.WebResourceAsIfPublished", true -> __.``dbo.WebResourceAsIfPublished``.ReadIfNotNull >> box
        | "dbo.WebResourceBase", false -> __.``dbo.WebResourceBase``.Read >> box
        | "dbo.WebResourceBase", true -> __.``dbo.WebResourceBase``.ReadIfNotNull >> box
        | "dbo.WebResourceBaseIds", false -> __.``dbo.WebResourceBaseIds``.Read >> box
        | "dbo.WebResourceBaseIds", true -> __.``dbo.WebResourceBaseIds``.ReadIfNotNull >> box
        | "dbo.WebResourceLogical", false -> __.``dbo.WebResourceLogical``.Read >> box
        | "dbo.WebResourceLogical", true -> __.``dbo.WebResourceLogical``.ReadIfNotNull >> box
        | "dbo.WebResourceLogicalAsIfPublished", false -> __.``dbo.WebResourceLogicalAsIfPublished``.Read >> box
        | "dbo.WebResourceLogicalAsIfPublished", true -> __.``dbo.WebResourceLogicalAsIfPublished``.ReadIfNotNull >> box
        | "dbo.WebResourceSnapshot", false -> __.``dbo.WebResourceSnapshot``.Read >> box
        | "dbo.WebResourceSnapshot", true -> __.``dbo.WebResourceSnapshot``.ReadIfNotNull >> box
